...
data_cfg = dict(
    image_size=256, # 256 512 640 1024
    base_size=256,
    base_sigma=2,
    heatmap_size=[256,], #256  512
...
model = dict(
    ...
    pretrained='https://download.openmmlab.com/mmpose/pretrain_models/hrnet_w48-8ef0771d.pth', #/home/chuanzhi/mnt_3T/lzc/workdir/cells/okad/best_320.pth
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
    ...
    test_cfg=dict(
        num_joints=channel_cfg['dataset_joints'],
        max_num_people=max_num_people,#1700 3500, #max_num_people
        scale_factor=[1],
        with_heatmaps=[True,],
        with_ae=[False,],#True
        project2image=True,
...
# /home/chuanzhi/mnt_3T/lzc/duixia/same/two/head_tail/coco   one/head
data_root = '/home/chuanzhi/mnt_3T/lzc/cell/ad/10'
...
data = dict(
    workers_per_gpu=1,
    train_dataloader=dict(samples_per_gpu=25), #8
    val_dataloader=dict(samples_per_gpu=1),
    test_dataloader=dict(samples_per_gpu=1),
    train=dict(
        type='BottomUpFishDataset',
        ann_file=f'{data_root}/coco/train/train2023.json', # 80
        img_prefix=f'/home/chuanzhi/mnt_3T/lzc/cell/ad/json',  #images/h  f'{data_root}/allImgs'
        data_cfg=data_cfg,
    ...
    val=dict(
        ...
        img_prefix=f'/home/chuanzhi/mnt_3T/lzc/cell/ad/json', #/images/val
        data_cfg=data_cfg,
