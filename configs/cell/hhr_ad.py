...
model = dict(
    ...
    keypoint_head=dict(
        ...
        loss_keypoint=dict(
            type='SingleLossFactory', #SingleLossFactory  MultiLossFactory
            num_joints=num_joints,
            num_stages=2,
            ae_loss_type='exp',
            with_ae_loss=[True, False],
    ...
    test_cfg=dict(
        num_joints=channel_cfg['dataset_joints'],
        max_num_people=1700,#max_num_people
        scale_factor=[1],
...
train_pipeline = [
    ...
    dict(
        ...
        sigma=2,
        max_num_people=1500,#max_num_people
    ),
    dict(
        type='Collect',
